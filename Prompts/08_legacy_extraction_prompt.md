# 08 — Legacy extraction prompt (superseded, kept for provenance)

> **What this is.** The prompt that produced the **first** ontology: 430 skills
> across 66 topics. It is no longer used. It is here because the project's
> supervisor and any future reader will reasonably ask how the approach evolved,
> and the delta between this and prompts `02`/`03` is the most interesting
> evidence the project has.
>
> **What it got right.** The Bloom-by-verb rule, the atomicity target and the
> reuse discipline all survive into the current prompts essentially unchanged.
>
> **What changed, and why:**
>
> | Then | Now | Because |
> |---|---|---|
> | Topics invented from whatever the sample covered (66 codes) | Fixed 183-topic HSC/NCTB syllabus taxonomy | The invented taxonomy gave Maths 9.4 topics per 100 skills and Chemistry 23.1 — an artefact of uneven sampling, not of the subjects |
> | Two small samples (1,379 physics + 300 mixed) | All 4,474 records, six books | The sample was never the corpus the project had |
> | No prerequisite-density requirement | >= 1.0 edges/skill, enforced per batch | Without it, 44% of skills came out with no edge at all and the DAG was a list in DAG clothing |
> | Single pass | 27 checkpointed batches + a 6-pass editorial stage | The job does not fit in one context window, and extraction alone does not produce a usable graph |
>
> **The measured result of the density change alone:** batches run before the
> fix averaged **0.47** edges per skill; every one of the 18 batches run after
> it came in above **1.0** with zero isolated skills. That is the cleanest
> before/after the project has on a prompt change.
>
> ---
