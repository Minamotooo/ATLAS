...
A diagnostic cannot test 430 skills in 30 questions, so it must choose skills
whose outcome is maximally informative about the rest of the graph. The engine
...
records of all six books --- at a granularity where a node names one action.
\Cref{tab:ontology-compare} compares the two.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{lrr}
    \toprule
    Property & Legacy (served) & Rebuild \\
    \midrule
    Skills & 430 & 1{,}688 \\
    Prerequisite edges & 471 & 1{,}743 \\
